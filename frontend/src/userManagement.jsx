...
const styles = {
  ...
  subtext: { color: "#888", marginBottom: "1.5rem", fontSize: 13 },
  section: { marginBottom: "1.5rem" },
  input: { width: "100%", padding: "8px 12px", fontSize: 14, borderRadius: 6, border: "1px solid #ccc", boxSizing: "border-box" },
  card: { background: "#f5f5f5", borderRadius: 8, padding: "12px 16px", marginBottom: "1.5rem", fontSize: 14, lineHeight: 1.8, color: "#1a1a1a" },
  groupGrid: { display: "flex", flexWrap: "wrap", gap: 8 },
  groupBtn: { padding: "6px 14px", borderRadius: 20, border: "1px solid #ccc", background: "#fff", cursor: "pointer", fontSize: 13, color: "#1a1a1a" },
  ...
  label: { display: "block", fontWeight: 600, marginBottom: 6, color: "#1a1a1a" },
  info: { color: "#444", fontSize: 13, marginTop: 6 },
};